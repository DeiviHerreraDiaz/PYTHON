...
num_personas = int(input("Cuantas personas se encuentran en el supermercado:\n"))
...
for i in range(num_personas):
    ...
    for j in range(1,num_productos+1):
        ...
        precio = int(input(f"Digite el precio del producto {j}\n"))
